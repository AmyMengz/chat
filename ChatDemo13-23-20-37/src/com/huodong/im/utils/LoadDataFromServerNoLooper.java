...
public class LoadDataFromServerNoLooper {
	
	private String url;
    private Map<String, String> map = null;
    private Context context;
	
	public LoadDataFromServerNoLooper(Context context, String url,
	 ...
	 public void getData(final DataCallBackNoLooper dataCallBack) {
////		 Handler ha=new 
//		 Looper.prepare();
...
//		 Looper.loop();
     ...
     *
     */
    public interface DataCallBackNoLooper {
