...
//	Button sendButton = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		initTopBarForLeft(getString(R.string.location_info));
		mMapView = (MapView) findViewById(R.id.bmapView);
		Intent intent = getIntent();
		double latitude = intent.getDoubleExtra(IntentConstant.KEY_LATITUDE, 0);
		...
		if (latitude == 0) {
			...
			double longtitude = intent.getDoubleExtra(IntentConstant.KEY_LONGITUDE, 0);
	...
	private void showMapWithLocationClient() {
		String str1 = getResources().getString(R.string.location_error);
