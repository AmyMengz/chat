...
import com.huodong.im.utils.SharePreferenceUtil;
...
public class SettingNewsActivity extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_settingnews);
		initTopBarForLeft("消息推送设置");
		initviews();
		init();
	}
	private void initviews()
	{
		view1=findViewById(R.id.view1_line);
	...
	private void init()
	{
		...
		//获取储存用户设置信息的SharePreference文件
		mSharedUtil=new SharePreferenceUtil(SettingNewsActivity.this, "1");//文件名后缀等从服务读取用户ID再拼凑
		// 初始化
