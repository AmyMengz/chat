...
/*	public void init(DatePicker datePicker, TimePicker timePicker) {
		...
		ad = new AlertDialog.Builder(activity)
				...
				.setPositiveButton("设置", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int whichButton) {
						dateTime=IMDateUserHelper.formatDateTime(dateTime);
	...
	public interface DateTimerCallback{
		public void onDateTimerCallback(String dateTime);
	}
	public AlertDialog dateTimePicKDialog(final TextView inputDate,final DateTimerCallback callback) {
		LinearLayout dateTimeLayout = (LinearLayout) activity
				.getLayoutInflater().inflate(R.layout.common_datetime_picker, null);
		datePicker = (DatePicker) dateTimeLayout.findViewById(R.id.datepicker);
		timePicker = (TimePicker) dateTimeLayout.findViewById(R.id.timepicker);
		...
		ad = new AlertDialog.Builder(activity)
				...
				.setPositiveButton("设置", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int whichButton) {
						dateTime=IMDateUserHelper.formatDateTime(dateTime);
						if(callback!=null){
							callback.onDateTimerCallback(dateTime);
						}
//						inputDate.setText(dateTime);
					}
				})
	...
	public void onDateChanged(DatePicker view, int year, int monthOfYear,
		...
		SimpleDateFormat sdf = new SimpleDateFormat(CommonUtil.timeFormat1);
...
//		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
	...
	private Calendar getCalendarByInintData(String initDateTime) {
		...
		Log.i("Amy 3-18", "yearStr.trim() "+yearStr.trim());
